...
namespace ContosoCrafts.WebSite.Pages.Product.WorkExperience
{
    ...
    /// </summary>
    public class UpdateWorkExperienceModel : PageModel
    {
        /// Data middletier
        ...
        public UpdateWorkExperienceModel(JsonFileProductService productService)
        {
