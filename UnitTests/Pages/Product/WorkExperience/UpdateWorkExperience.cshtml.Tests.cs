...
namespace UnitTests.Pages.Product.WorkExperience
{
    ...
    {
        #region TestSetup
        // UpdateWorkExperience page to test
        public static UpdateWorkExperienceModel pageModel;
        ...
        {
            pageModel = new UpdateWorkExperienceModel(TestHelper.ProductService)
            {
            };
        }
        #endregion TestSetup
        ...
        /// </summary>
        [Test]
        public void OnGet_Valid_Should_Return_A_Work_Experience_Record()
        {
            // Arrange
