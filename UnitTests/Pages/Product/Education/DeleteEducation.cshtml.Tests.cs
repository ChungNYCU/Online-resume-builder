...
namespace UnitTests.Pages.Product.Education
{
    class DeleteEducationTests
    {
        ...
        public static DeleteEducationModel pageModel;
        ...
        {
            pageModel = new DeleteEducationModel(TestHelper.ProductService)
            {
            };
        }
        #endregion TestSetup
        ...
        public void OnGet_InValid_ProductID_Should_Return_Index_Page()
        {
            ...
            // Act
            var result = pageModel.OnGet(ProductID, "InValidEducationID") as RedirectToPageResult;
